    ...
    <div className="m-2">
        ...
        {postHovered && (
          ...
          >
            ...
            <div className=" flex justify-between items-center gap-2 w-full">
              {destinationURL?.slice(8).length > 0 ? (
                <a
                  href={destinationURL}
                  target="_blank"
                ...
                >
                  ...
                  {destinationURL?.slice(8, 17)}...
                </a>
              ) : undefined}
              {whoPosted?._id === user?.sub && (
                <button
                  type="button"
                  onClick={(e) => {
                    e.stopPropagation();
      ...
      >
        <img
          ...
          alt="user-profile"
        />
        <p className="font-semibold capitalize">{whoPosted?.userName}</p>
      </Link>
    </div>
  );
};

export default IndividualImageTile;
